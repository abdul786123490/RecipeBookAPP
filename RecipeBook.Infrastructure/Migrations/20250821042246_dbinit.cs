    ...
    public partial class dbinit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietaryInformation", x => x.DietaryId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RecipeDietaries",
                columns: table => new
                {
                    RecipeDietaryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecipeId = table.Column<int>(type: "int", nullable: false),
                    DietaryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeDietaries", x => x.RecipeDietaryId);
                    table.ForeignKey(
                        name: "FK_RecipeDietaries_DietaryInformation_DietaryId",
                        column: x => x.DietaryId,
                        principalTable: "DietaryInformation",
                        principalColumn: "DietaryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeDietaries_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "RecipeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeDietaries_DietaryId",
                table: "RecipeDietaries",
                column: "DietaryId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeDietaries_RecipeId",
                table: "RecipeDietaries",
                column: "RecipeId");
